...
value=that._currentQuery):(that._highlighted-=1,value=that._suggestions[that._highlighted]),that._toogleHighlighted(),that._options.html||(that._el.value=value)}),ch.shortcuts.add(ch.onkeydownarrow,this.uid,function(){var value;null===that._highlighted?(that._highlighted=0,value=that._suggestions[that._highlighted]):that._highlighted>=that._suggestionsQuantity-1?(that._highlighted=null,value=that._currentQuery):(that._highlighted+=1,value=that._suggestions[that._highlighted]),that._toogleHighlighted(),that._options.html||(that._el.value=value)}),this._popover.on("show",function(){ch.shortcuts.on(that.uid)}),this._popover.on("hide",function(){ch.shortcuts.off(that.uid)}),this.on("destroy",function(){ch.shortcuts.remove(this.uid)}),this}}(this.ch.Autocomplete,this.ch),window.onload=function(){new ch.Carousel(document.querySelector(".myCarousel"),{limitPerPage:3})};